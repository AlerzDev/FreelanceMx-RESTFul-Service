...
import repositories.UserFreelanceRepository;
...
@Path("/users")
public class UserFreelanceEndPoint extends EndPointBase<UserFreelance> implements EndPointApi<UserFreelance> {

    @Inject
    private UserFreelanceRepository services;

    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/insert")
    @Override
    public Response newItem(UserFreelance item) {
        try {
    ...
    @Path("/update")
    @Override
    public Response updateItem(UserFreelance item) {
        try{
